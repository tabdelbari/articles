...
class IeeeSpider(scrapy.Spider):
    ...
    def parse_1(self, response):
        ...
        for record in jr['records']:
            ...
            metrics_url = "https://ieeexplore.ieee.org/rest/document/" + jr['articleNumber'] + "/metrics"
    ...
    def parse_2(self, response):
        ...
        authors_url = "https://ieeexplore.ieee.org/document/" + record['articleNumber'] + "/authors#authors"
        yield SplashRequest(authors_url, self.parse_2, endpoint='execute',
                            magic_response=True, meta={'handle_httpstatus_all': True, 'data': result},
                            args={'lua_source': self.lua_script, 'http_method': 'GET', 'body': None, 'headers': headers})
        pass
