...
class IeeeSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        post_data = '{\r\n    \"queryText": "' + self.topic + ', "highlight": true, "returnType": "SEARCH", "matchPubs": true, "rowsPerPage": 100, "returnFacets": ["ALL"]}'
    ...
    """
    def start_requests(self):
        req = scrapy.Request('https://ieeexplore.ieee.org/rest/search', callback= self.init_articles,method='POST', headers={ 
        ...
        yield SplashRequest('https://ieeexplore.ieee.org/rest/search', callback=self.init_articles, args={ 'wait': 10 })
