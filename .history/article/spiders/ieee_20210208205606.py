...
class IeeeSpider(scrapy.Spider):
    ...
    def parse_1(self, response):
        ...
        for record in jr['records']:
            ...
            authors_ids = 'authors': '|'.join(list(map(lambda author: author['preferredName'], record['authors'])))
            for author in record['authors']:
                author_url = 'https://ieeexplore.ieee.org/rest/author/' + str(author['id'])
                yield SplashRequest(author_url, self.parse_author, endpoint='execute',
            ...
            metrics_url = "https://ieeexplore.ieee.org/rest/document/" + \
                record['articleNumber'] + "/metrics"
