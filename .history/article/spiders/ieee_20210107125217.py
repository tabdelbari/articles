...
class IeeeSpider(scrapy.Spider):
    ...
    def __init__(self, topic='', keywords='', **kwargs):
        ...
        self.ost_url = 'https://ieeexplore.ieee.org/rest/search'        # self.start_urls = ['https://ieeexplore.ieee.org/search/searchresult.jsp?newsearch=true&queryText=%s' %keywords]
        self.topic = topic
