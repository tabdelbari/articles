...
class SciencedirectSpider(scrapy.Spider):
    ...
    def __init__(self, topic='', keywords='', **kwargs):
        ...
        self.start_urls = ['https://www.sciencedirect.com/search?qs=' + keywords]
        self.topic = topic
    ...
    def find_articles(self, response):
        ...
        for article_url in articles_urls:
            ...
            yield SplashRequest(article_url, callback=self.parse, args={ 'wait': 4 })
        ...
        if next_page != '':
            ...
            yield SplashRequest(next_page, callback=self.find_articles, args={ 'wait': 4 })
