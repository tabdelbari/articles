...
class IeeeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # TODO: search for country using xpath, try using the following xpath (im not sure)
        adresses = response.xpath('//*/div[@class="author-card"]/div/div/div/div/text()').getall()
        # result['lab'] = ...
        # result['organisation'] = ...
        # result['city'] = ...
        # result['country'] = ...
